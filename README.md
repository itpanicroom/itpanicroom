...
Cloud Architect operating where theory breaks and production burns

Skilled in Microsoft 365 SaaS, Azure, Entra, Defender, and the Zero Trust stack

Security-first, adoption-aware, grounded in the SMB grind

I document what breaks, why it breaks, and how to make it bulletproof


🧠 Core Domains

Identity & Security: Passwordless, Conditional Access, Entra ID Governance
